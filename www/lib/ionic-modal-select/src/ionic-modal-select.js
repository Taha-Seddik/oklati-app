 modalSelectTemplates = modalSelectTemplates || {};modalSelectTemplates['modal-template-multiple.html'] = ' <ion-modal-view class="ionic-select-modal" ng-class="::ui.modalClass">\n' +
    '\n' +
    '    <ion-header-bar ng-class="::ui.headerFooterClass">\n' +
    '      <h1 class="title " style="text-align:center;">{{::ui.modalTitle}}</h1>\n' +
    '    </ion-header-bar>\n' +
    '\n' +
...
var modalSelectTemplates = modalSelectTemplates || {};modalSelectTemplates['modal-template.html'] = ' <ion-modal-view class="ionic-select-modal" ng-class="::ui.modalClass">\n' +
    '    \n' +
    '    <ion-header-bar ng-class="::ui.headerFooterClass">\n' +
    '      <h1 class="title sizeBTN">{{::ui.modalTitle}}</h1>\n' +
    '    </ion-header-bar>\n' +
    '\n' +
    '    <div class="bar bar-subheader item-input-inset" ng-class="::ui.subHeaderClass" ng-if="ui.hasSearch">\n' +
    '      <label class="item-input-wrapper">\n' +
    ...
    '    </div>\n' +
    '\n' +
    '    <ion-content class="has-header modalBack" ng-class="{\'has-subheader\':ui.hasSearch}">\n' +
    '        <div class="text-center" ng-if="!ui.shortList && !showList" style="padding-top:40px;">\n' +
    '            <h4 class="muted">{{::ui.loadListMessage}}</h4>\n' +
    '            <p>\n' +
    '                <ion-spinner></ion-spinner>\n' +
    ...
    '\n' +
    '    <ion-footer-bar ng-class="::ui.headerFooterClass">\n' +
    '        <button type="button" class="button button-stable modal-select-close-button sizeBTN" ng-click="closeModal()">{{ui.cancelButton}}</button>\n' +
    '        <button type="button" ng-if="::!ui.hideReset" class="button button-stable sizeBTN" ng-click="unsetValue()">{{ui.resetButton}}</button>\n' +
    '    </ion-footer-bar>\n' +
    '\n' +
    '</ion-modal-view>\n' +
    '';
		...
		.directive('modalSelect', ['$ionicModal','$timeout', '$filter', '$parse', '$templateCache',
            ...
            var multipleNullValue = iAttrs.multipleNullValue ? scope.$eval(iAttrs.multipleNullValue) : [];
						...
						scope.ui = {
							...
							resetButton : iAttrs.resetButton || 'الكل',
							cancelButton : iAttrs.cancelButton || 'أغلق',
							...
							itemClass: iAttrs.itemClass || 'item item-text-wrap dfdf titan2',
